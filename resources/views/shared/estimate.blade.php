...
<template id="estimate-panel-template">
    <div v-show="showEstimatePanel">
        ...
        <div style="z-index: 99999999;position: fixed;top: calc(50% - 250px);right: calc(50% - 250px)">
            <div v-on:click="close" style="position: absolute;top: 10px;right: 10px;cursor: pointer;font-size: 30px">
                ×
            </div>
